    ...
    render() {
        ...
        return (
           <>
            ...
            <div className="newmain" > 
               ...
               <div className="caption"><b onClick={() => this.props.history.push(`/topic/${correctOne.topic_title.toLowerCase()}`) }>#{correctOne.topic_title} </b>
       ...
       <button id={this.props.topicPost.id} onClick={(event) => this.props.deletePostFromTopic(event)} className="xOut">x</button>
         ...
         <p className="date">Published on {new Date(this.props.topicPost.published_at).toString()}</p>
               ...
               <br/>{this.props.topicPost.caption}<br/> <a className="post_link" href={this.props.topicPost.url} target="_blank" rel="noopener noreferrer">{this.props.topicPost.url}</a> </div>
               ...
               <a href={`sms:Text Someone&body=${this.props.topicPost.caption}%0D%0A%0D%0A${this.props.topicPost.url}`}><img src="/imessage.png" alt="imessage" name="imessage" className="iMessage"/>iMessage</a>
               
                <a href={`mailto:?subject=${this.props.topicPost.caption}&body=Hey you!%0D%0A%0D%0ACheck out this cool article I found on Fetch:%0D%0A%0D%0A${this.props.topicPost.url}`}><img src="mail.png" alt="email" className="email"/>Email</a>
